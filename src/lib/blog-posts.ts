...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And notice what happens if I am wrong. Every client already owns their code and their data, outright. If this company vanished tomorrow, their systems keep running like nothing happened. <span style="color: #FF5500; font-weight: 800;">The bet is his. Nobody else at this table has money down.</span></p>

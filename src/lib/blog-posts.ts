...
export const blogPosts: Post[] = [
    {
        ...
        seoDescription:
            'Rented software gives you one vote out of thousands. Owned software puts the roadmap in your name. Four texts changed one owner’s system before lunch. Part 2.',
        date: '2026-09-04',
        author: 'Trevor Ruby',
        authorImage: '/trevorruby.jpeg',
        excerpt:
            'A lease tells you what you may do. A deed tells everybody else what they may not. Part 2 of the series: why the roadmap of the software your business runs on should be in your name — including the list of what never gets built.',
        image: '/images/blog/roadmap-deed-og-v1.png',
        hideHero: true,
        content: `
<p style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 3px; color: #FF5500; text-transform: uppercase; margin: 0 0 1.6em;">Owned software &middot; part two</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">A lease tells you what you&rsquo;re allowed to do. A deed tells everybody else what they&rsquo;re not. That&rsquo;s the whole difference between renting software and owning it, and nowhere does it show up harder than the roadmap. When you rent, you&rsquo;re one vote out of thousands on somebody else&rsquo;s land. <span style="color: #FF5500; font-weight: 800;">When you own, the roadmap is in your name.</span></p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Four texts before lunch.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The dealer from <a href="/blog/self-improving-software" style="color: #FF5500;">Part 1</a> &mdash; the national e-commerce operation whose software wrote its own work order &mdash; read his system&rsquo;s forward-planning page over morning coffee. Then he texted me a short list.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">One text said the page was wrong about how his company buys. &ldquo;We don&rsquo;t order containers.&rdquo; By late morning the page ran reorder math instead of container math. One said &ldquo;Change the favicon&rdquo; with a smiley &mdash; his brand mark was the tab icon before lunch. One said put the dashboard at an admin subdomain of his own store&rsquo;s domain, and the app&rsquo;s front door moved the same day. One flagged a login button with invisible text. Fixed within the hour.</p>
<div style="margin: 2em 0; padding: 1.2em 1.4em; border: 1px solid #333; border-radius: 16px; text-align: center;"><div style="font-size: clamp(38px, 7vw, 68px); font-weight: 800; line-height: 1; letter-spacing: -0.03em; color: #FF5500;">4 texts / 0 tickets / same day</div><div style="font-size: clamp(13px, 1.8vw, 16px); letter-spacing: 2px; text-transform: uppercase; opacity: 0.7; margin-top: 0.6em;">No forum &middot; no roadmap committee &middot; no &ldquo;we&rsquo;ve logged your feedback&rdquo;</div></div>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">He didn&rsquo;t submit feedback. He gave instructions. It&rsquo;s his.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">You&rsquo;re not 1/1000 voting on a direction. <span style="color: #FF5500;">You&rsquo;re sovereign over it.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Go look at the feature-request forum for the software you rent. A feature-request forum is a waiting room with a scoreboard &mdash; ideas sitting at &ldquo;planned&rdquo; since before your last truck was new. Grown business owners begging, in public, for a checkbox. Voting is what tenants do. The landlord counts the votes and builds whatever pencils out for the landlord.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And slow is the good outcome. Features you use get pulled out and repackaged into a higher tier. Prices go up because the roadmap needed funding for customers who are not you. Sometimes the whole product gets sunset by an announcement email &mdash; roadmap over. A rented roadmap can be revoked by one email. A deed can&rsquo;t. None of this is a scandal. It&rsquo;s just math: the roadmap of rented software serves the vendor&rsquo;s average customer, and no real business is anybody&rsquo;s average.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">The average is a ghost, and the ghost outvotes you every single quarter.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">The deed includes what will never be built.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">People think a roadmap is a wish list. Half of it is a fence line. Roxanne runs a wholesale nursery, and her rule is that prices never print on crew-facing paper &mdash; that rule is written into the code. DJ&rsquo;s Bail Bonds runs a system that is banned from answering his phone, and the ban is printed right on its front screen. Doggett Law Firm&rsquo;s system will not calculate a deadline and cannot touch a dollar of client money.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The owners drew those fence lines themselves, and no update can move them. Try getting a never-build promise out of a vendor whose growth plan depends on building it. An owned roadmap says what the software becomes and what it never will &mdash; and the same hand signs both lists.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">When you own the software, your no is as permanent as your yes.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Your software sits on your roadmap now. As a researcher.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The Shipwright from Part 1 still runs every Monday at 5:31 in the morning. It researches one improvement to the owner&rsquo;s system, writes the full case with the cost in days, commits the work order into the owner&rsquo;s own repository, and stops. The owner says go or skip. A skip gets logged with the reason, and the reason teaches the next cycle.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">So the roadmap has an R&amp;D department now. It works Mondays before dawn, it never pitches two things at once, and it answers to one person &mdash; and that person is not a product committee, and he is damn sure not the average customer.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">Your business has an R&amp;D department. It reports to you.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Whose name is on your roadmap?</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Pull up the software your business runs on and ask one question: if you texted the people who make it four things tomorrow morning, what happens by lunch? If the honest answer is a ticket number, you&rsquo;re a tenant. Tenants don&rsquo;t decide what the land becomes. That&rsquo;s just what a lease is.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">We build systems that run beside your current one, penny-matched nightly, until you say switch. Month to month, thirty days notice, and if you ever walk, the code and the data walk with you. The deed stays in your name either way. Bring the thing that&rsquo;s annoyed you the longest. <span style="color: #FF5500; font-weight: 800;">That&rsquo;s usually week one.</span></p>
<div style="margin: 2em 0 0; display: flex; flex-wrap: wrap; gap: 12px;"><a href="/fit" style="display: inline-block; background: #FF5500; color: #0A0A0A; font-weight: 800; padding: 14px 22px; border-radius: 12px; text-decoration: none; text-transform: uppercase; letter-spacing: 0.04em;">Bring Me Your Four Texts &rarr;</a></div>
...
`,
    },
    {
        ...
        authorImage: '/trevorruby.jpeg',
        excerpt:
            'Every Monday before dawn, one of the operating systems we built researches its own next improvement and writes one work order. Then it stops — it can write the work order, it cannot sign it. Cycle one: 114 abandoned carts carrying $498,691.18 in gross cart value.',
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every Monday at 5:31 in the morning, one of the operating systems we built researches its own next improvement and writes one work order: what to build, why the owner will feel it, how many days. Then it stops. <span style="color: #FF5500; font-weight: 800;">Nothing happens until a human says yes.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">It studies the business — a national e-commerce dealer, a real client, name withheld at his request — writes one work order, and waits behind a human gate. Cycle one ran September 4 — fired by hand, ahead of the schedule, to see what it would choose. The first automatic run comes Monday at 5:31 AM Central. Three feeds — its own gap lists, what the market shipped, what new technology unlocks — all pointed at the same dead handoff.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Best line in the file: it talked itself out of the project an engineer would pick — five to seven days of technically interesting chassis — because &ldquo;on day seven the owner feels nothing.&rdquo; I have sat in meetings where the humans could not manage that.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every rented product has one roadmap shared by thousands of customers. A good vendor listens — and still builds for the market. You are <span style="color: #FF5500; font-weight: 800;">one vote</span>. To software owned by one business, that business is the entire market. Every Monday proposal is committed into this dealer's own repository, beside the code and the data he already owns.</p>

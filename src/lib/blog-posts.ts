...
export const blogPosts: Post[] = [
    {
        ...
        title: 'The Roadmap Is in the Deed.',
        seoTitle: 'The Roadmap Is in the Deed',
        seoDescription:
            'A 593-line software plan looked complete. Then we told another machine to attack it. What came back — 2571 lines, 19 named risks, 6 owner gates — is who really owns a custom roadmap.',
        date: '2026-09-04',
        author: 'Trevor Ruby',
        authorImage: '/trevorruby.jpeg',
        excerpt:
            'A 593-line plan looked complete. Then we told another machine to attack it. What came back is the difference between owning software and renting somebody else’s future.',
        image: '/images/blog/roadmap-deed-og-v2.png',
        hideHero: true,
        content: `
<p style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 3px; color: #FF5500; text-transform: uppercase; margin: 0 0 1.6em;">Owned software &middot; part two &middot; a true story from this week</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">The first plan was good enough to be dangerous.</span> It was 593 lines long. It mapped nearly every piece of software inside an equipment dealership we are fitting right now: the inbox, inventory, quotes, trade-ins, financing, signatures, service, parts, AI, advertising feedback, and the eventual path out of the dealer system underneath all of it. Tables. Timelines. Database fields. A sixteen-week build order. It looked finished.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">So I handed it to another machine and gave it one instruction:</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">Try to kill this plan.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Do not make it prettier. Do not congratulate it. Find every place it could lose a message, promise the same machine to two people, charge one deposit twice, teach the AI a wrong answer, corrupt inventory, or leave the owner with software he technically owned but could not safely run.</p>
<div style="margin: 2em 0; border: 1px solid #333; border-radius: 16px; overflow: hidden;">
<p style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 3px; color: #FF5500; text-transform: uppercase; margin: 0 0 1.6em; margin: 1em 1.2em 0.2em; ">The receipt</p>
<div style="display: grid; grid-template-columns: repeat(4, 1fr);">
<div style="padding: 0.9em 0.6em; text-align: center;"><div style="font-size: clamp(22px, 3.6vw, 34px); font-weight: 800; letter-spacing: -0.02em; line-height: 1;">593</div><div style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 10px; letter-spacing: 1.6px; text-transform: uppercase; opacity: 0.6; margin-top: 0.5em;">lines &middot; original plan</div></div>
<div style="padding: 0.9em 0.6em; text-align: center;"><div style="font-size: clamp(22px, 3.6vw, 34px); font-weight: 800; letter-spacing: -0.02em; line-height: 1; color: #FF5500;">2571</div><div style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 10px; letter-spacing: 1.6px; text-transform: uppercase; opacity: 0.6; margin-top: 0.5em;">lines &middot; adversarial rebuild</div></div>
<div style="padding: 0.9em 0.6em; text-align: center;"><div style="font-size: clamp(22px, 3.6vw, 34px); font-weight: 800; letter-spacing: -0.02em; line-height: 1;">19</div><div style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 10px; letter-spacing: 1.6px; text-transform: uppercase; opacity: 0.6; margin-top: 0.5em;">risks named</div></div>
<div style="padding: 0.9em 0.6em; text-align: center;"><div style="font-size: clamp(22px, 3.6vw, 34px); font-weight: 800; letter-spacing: -0.02em; line-height: 1;">6 / 49</div><div style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 10px; letter-spacing: 1.6px; text-transform: uppercase; opacity: 0.6; margin-top: 0.5em;">owner gates &middot; work orders</div></div>
</div>
</div>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">The first plan understood the dealership. The second understood how software fails.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">The sentence we had wrong.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The first plan said the conversation should sit at the center of the system. That sounds right &mdash; every sale starts somewhere: a text, a Facebook message, a call, a form, a man walking through the front door. But the conversation is not the customer. It is not the machine on the lot, not the quote, not the deposit, not the repair order, not the signed paperwork. A husband can text. His wife can call. The service department can talk to both of them six months later. Those conversations should all point to the same durable business record. None of them should own it.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">That one correction changed the foundation underneath the whole build. A large plan is not the same thing as a safe plan &mdash; the more complete a bad assumption looks on paper, the more expensive it becomes in code.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What actually changed.</p>
<div style="margin: 1.4em 0 1.8em; padding: 0.3em 1.2em 0.8em; border: 1px solid #333; border-radius: 16px;">
<div style="display: flex; gap: 14px; padding: 0.6em 0; border-bottom: 1px solid #222; align-items: baseline; font-size: clamp(14px, 1.9vw, 17px);"><span style="opacity: 0.6; flex: 1;">Replace nearly everything in sixteen weeks</span><span style="color: #FF5500; flex-shrink: 0;">&rarr;</span><span style="font-weight: 700; flex: 1;">Prove one revenue loop first</span></div>
<div style="display: flex; gap: 14px; padding: 0.6em 0; border-bottom: 1px solid #222; align-items: baseline; font-size: clamp(14px, 1.9vw, 17px);"><span style="opacity: 0.6; flex: 1;">The conversation owns every record</span><span style="color: #FF5500; flex-shrink: 0;">&rarr;</span><span style="font-weight: 700; flex: 1;">Customer, deal, unit, and work survive across conversations</span></div>
<div style="display: flex; gap: 14px; padding: 0.6em 0; border-bottom: 1px solid #222; align-items: baseline; font-size: clamp(14px, 1.9vw, 17px);"><span style="opacity: 0.6; flex: 1;">An approved AI reply becomes reusable memory</span><span style="color: #FF5500; flex-shrink: 0;">&rarr;</span><span style="font-weight: 700; flex: 1;">Approval does not automatically make an answer true</span></div>
<div style="display: flex; gap: 14px; padding: 0.6em 0; border-bottom: 1px solid #222; align-items: baseline; font-size: clamp(14px, 1.9vw, 17px);"><span style="opacity: 0.6; flex: 1;">Build high-stakes e-signing ourselves, now</span><span style="color: #FF5500; flex-shrink: 0;">&rarr;</span><span style="font-weight: 700; flex: 1;">Defer it until the evidence and controls exist</span></div>
<div style="display: flex; gap: 14px; padding: 0.6em 0; border-bottom: 1px solid #222; align-items: baseline; font-size: clamp(14px, 1.9vw, 17px); border-bottom: none;"><span style="opacity: 0.6; flex: 1;">Assume scheduled jobs behave</span><span style="color: #FF5500; flex-shrink: 0;">&rarr;</span><span style="font-weight: 700; flex: 1;">Every outside action survives a retry without happening twice</span></div>
</div>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The corrected plan asks the questions a feature list avoids. What happens when two customers put money on the same machine at nearly the same time? When the payment company reports one deposit twice? When the old system says sold and the website still says available? None of those questions make a prettier demo. All of them make a safer business.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The first horizon is now one loop: a customer asks about a machine, the right person answers, the exact unit stays attached, a correct quote goes out, a deposit lands, one and only one unit becomes reserved, and management can see it happened. Then the new inbox earns the right to replace the old one. Then service. Then parts. Then financing, documents, and carefully controlled AI &mdash; each behind its own gate, each with a way back. Because a roadmap that cannot say <span style="color: #FF5500; font-weight: 800;">not yet</span> is not a roadmap. It is advertising.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">This is where ownership gets real.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Most software companies own the roadmap. You can request a feature, vote on a feature, read a release note when they build some version of it for thousands of customers. But you do not decide what comes next.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">You rent the present and petition for the future.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Owned software changes that deal. The owner does not merely receive whatever code exists on launch day &mdash; he controls what the system is allowed to become next. That does not mean unlimited development is free. It means the business decides what is worth funding, what should wait, what must never be automated, and who is allowed to build it. We have watched it work at speed, too: another owner on this fleet texted four corrections over morning coffee this week, and every one was live in his software before lunch.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And a real ownership deed settles more than two nouns. The code and the intellectual property. The data and the structure required to understand it. The accounts and infrastructure the system depends on. The instructions to deploy, restore, and operate it. The current roadmap, open decisions, and known risks. The right to continue with another qualified builder. A zip file nobody else can run is not freedom. A roadmap held only in the developer&rsquo;s head is not ownership. A deed you cannot exercise is decoration.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">The owner outranks every machine.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">I do not care which AI wrote the first plan. I do not care which AI found the flaw. I care which answer survives contact with the business. We do not have to defend the first answer because it was ours &mdash; we can put it on the table, let another intelligence tear it apart, keep what survives, and hand the owner the stronger plan. He can change the order, reject a module, hold back an automation, demand more proof, replace the builder, and keep the system. That is not friction in the process. That is the product.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">The client should never be trapped inside our first idea.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Whose roadmap is it?</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">On launch day this dealer will own the code and the data. But ownership started earlier &mdash; the moment the plan could be wrong in public, when a better answer could replace our answer without threatening our ego or his investment. Ask your software company what is on its roadmap. Then ask the question underneath it: whose roadmap is it? With rented software, the answer is theirs. With this one, the roadmap and the deed point to the same owner.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The spreadsheet. The duplicate entry. The quote living in somebody&rsquo;s texts. The one task everybody knows is stupid but nobody has had time to fix. Show us how the work really moves, and we will map the first loop worth owning &mdash; and the ways it could fail &mdash; before we ask you to bet the business on it.</p>

...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">The first plan was good enough to be dangerous.</span> 593 lines. It mapped nearly everything inside an equipment dealership we are fitting right now &mdash; inbox, inventory, quotes, financing, service, parts, AI. Tables. Timelines. A sixteen-week build order. It looked finished.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">So I handed it to another machine with one instruction: try to kill this plan.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Find every place it could lose a message. Promise the same machine to two people. Charge one deposit twice. Teach the AI a wrong answer. Leave the owner with software he technically owned but could not safely run.</p>
...
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What changed.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The new plan starts with one loop: a customer asks about a machine, a correct quote goes out, a deposit lands, one and only one unit gets reserved. Everything else waits its turn behind a gate. Because a roadmap that cannot say <span style="color: #FF5500; font-weight: 800;">not yet</span> is not a roadmap. It is advertising.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Why this is an ownership story.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Rented software has one roadmap shared by thousands of customers. You rent the present and petition for the future. Owned software flips the deal: the owner decides what gets built, what waits, and what never gets automated. We can let another machine tear up our own plan, because our ego is not the product.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Ask your software company whose roadmap you are on. With rented software, the answer is theirs. With this one, the roadmap and the deed point at the same man.</p>

...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Owning your software isn't a new idea, and I'm not going to pretend it is. Perpetual licenses. On-premise. Self-hosted. 37signals sells pay-once apps and says the subscription era went too far. All smart, all circling it for years. <span style="color: #FF5500;">But every one of those names describes how you paid or where it runs.</span> Not one names the thing an owner actually cares about: what do you HAVE when the dust settles? SaaS got a name that sells itself. The opposite got IT terminology. That's the whole gap.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">So here's the name. <span style="color: #FF5500;">Owned software.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">One question tells you which one you have. <span style="color: #FF5500;">If you stop paying, what's left?</span> Rented: a dead login and your records on somebody else's server. Owned: everything. Still yours. Still running.</p>

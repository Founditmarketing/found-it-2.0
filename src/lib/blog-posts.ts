...
export const blogPosts: Post[] = [
    {
        ...
        excerpt:
            'Every Monday before dawn, one of the operating systems we built researches its own next improvement and writes one work order. Then it stops â€” it can write the work order, it cannot sign it. Cycle one: 114 abandoned carts carrying $498,691.18 in gross cart value.',
        image: '/images/blog/shipwright-og-v2.png',
        hideHero: true,
        content: `
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">It studies the business â€” a national e-commerce dealer, a real client, name withheld at his request â€” writes one work order, and waits behind a human gate. Cycle one ran last night. Three feeds â€” its own gap lists, what the market shipped, what new technology unlocks â€” all pointed at the same dead handoff.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Some of those carts were never coming back. But 114 reached checkout and left, the system already had a board showing every one â€” and the board got looked at, never worked.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">So the proposal is a morning call queue: the five biggest walkaways, phone numbers first, a script drafted in the company's own voice. Two and a half days of work. One rule on the scoreboard:</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">A dollar counts only when the order lands in the books. Never when a button gets tapped.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Then it stopped.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The work order was finished, and the machine is not allowed to take the next step. Not discouraged â€” <span style="color: #FF5500; font-weight: 800;">not allowed</span>. One word from the owner: go, or skip. A skip gets logged with the reason, and the reason teaches next week's cycle. The whole file is above â€” the evidence, what it refused, what it is forbidden to touch. This is <a href="/blog/giving-owners-full-control" style="color: #FF5500;">Owner Mode</a> pointed at the roadmap itself.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Best line in the file: it talked itself out of the project an engineer would pick â€” five to seven days of technically interesting chassis â€” because &ldquo;on day seven the owner feels nothing.&rdquo; I have sat in meetings where the humans could not manage that.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every rented product has one roadmap shared by thousands of customers. A good vendor listens â€” and still builds for the market. You are <span style="color: #FF5500; font-weight: 800;">one vote</span>. To software owned by one business, that business is the entire market. Every Monday proposal is committed into this dealer's own repository, beside the code and the data he already owns.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Code ownership tells you who owns the software today. <span style="color: #FF5500;">Roadmap ownership tells you who controls what it becomes tomorrow.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">One cycle. Nothing built, nobody called, scoreboard $0.00. That is the correct state for a system that asks first. When the scoreboard says something real, I will publish it â€” small numbers too.</p>
...
`,
    },
    {
        ...
        date: '2026-08-29',
        excerpt: 'The work was real. The hire was never going to happen. So the owner worked the job after everybody else went home. The night secretary, the bid department, the auditor â€” carefully limited, and owned outright.',
        author: 'Trevor Ruby',
        authorImage: '/team-member-1.jpeg',
        image: '/images/blog/your-new-employee-og-v1.png',
        hideHero: true,
        content: `
<p style="font-family: monospace; font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; opacity: 0.55; margin: 0 0 1.2em;">Field note Â· owned software</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">When a great employee leaves, years of company knowledge can leave with them. When a rented platform changes its terms â€” or the business stops paying â€” the working system can leave too. Owned software is different. The system is built around the way the company actually operates, the code and the data belong to the business outright, and the operating knowledge stays inside the company that created it. The people are still people. The judgment stays human. But the company no longer has to rent access to its own memory.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">What we are really building is the missing department â€” the work that mattered enough to keep doing but never fit a job anyone was going to be hired for. The phone gets answered. The bid gets found. The books get checked. The decisions stay human. The system stays with the business. <strong>And the owner gets the night back.</strong></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">It's already emerging, in versions. 37signals' ONCE apps, run on your own server: the mass-produced version. The open-source and self-hosted world has carried the flag for decades: the build-it-from-parts version. We build the bespoke version, one business at a time. Different builders, different methods, <span style="color: #FF5500;">one shift: businesses deciding they should own the software they run on.</span> The term is starting to emerge across the industry, and good â€” a category gets more useful when more than one builder can qualify under it. Our job isn't to own the words. It's to make the standard clear, and to build the bespoke version well enough that businesses like yours can finally buy it.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">Nobody rents you your own business back.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><a href="/owned-software" style="color: #FF5500; font-weight: 700;">The category, defined â†’</a></p>
`,
    },
    {
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Written is written â€” not me, not you, not an employee having a bad day, not the AI. Mistakes get fixed in the open, with a dated reversal. Your bank keeps its books this way. That is why you believe your statement.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The new books run beside your QuickBooks, matched to the penny, until you say go â€” on your clock, not a salesman's. And the ledger is yours: code, data, every number, the same way the cash in your drawer is. <span style="color: #FF5500; font-weight: 800;">Nobody rents you your own business back.</span></p>
...
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;"><span style="color: #FF5500;">â€œShe's never gonna have to use that pen, ever again.â€</span></p>
...
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;"><span style="color: #FF5500;">â€œ$3,000 balance. $500 every two weeks. Populate the dates.â€</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">We stood in that office â€” that's why the ban exists. The phone stays human, day and night, forever. <strong>Half of this job is knowing what to build. The other half is knowing what to refuse.</strong></p>
...
`,
    },
    {
        ...
        date: '2026-08-24',
        excerpt: 'It answers the 9 PM call, opens the intake, drafts the demand â€” and stops exactly where Kennethâ€™s license begins. Two locked doors: it cannot practice law, and it cannot control client money. Software his firm owns outright.',
        author: 'Trevor Ruby',
        authorImage: '/team-member-1.jpeg',
        image: '/images/blog/lawyer-og-visual-v1.png',
        hideHero: true,
        content: `
<p style="font-family: monospace; font-size: 11px; letter-spacing: 0.14em; text-transform: uppercase; opacity: 0.55; margin: 0 0 1.2em;">Field report Â· Doggett Law Firm Â· real system Â· invented cases Â· no client data</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">It answers the 9 PM call, opens the intake, drafts the demand â€” and stops exactly where Kenneth's license begins.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The next morning, one screen: the calls she took, the matters that need his eyes, the dates waiting for his acknowledgment, the money sitting invoiced. All of it waiting with his coffee â€”</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Walks out of court, says what happened out loud. The file note, the to-dos, the time he spent â€” filed. Typing is not the part that needs a law license. Judgment is. The machine handles the typing. <span style="color: #FF5500; font-weight: 800;">Kenneth keeps the judgment.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Louisiana prescription â€” the clock that kills a case â€” is not a date I want software pretending to understand. Kenneth enters every legal deadline himself. The system records the date he chose, stamps it with his name, counts down from it, asks him to acknowledge it, and gets increasingly loud when he doesn't â€”</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The medical specials, the outstanding balances, the liens â€” already in the file. So it assembles the demand letter on Doggett Law Firm letterhead in one tap. Look closely at the stamp: <strong>DRAFT.</strong> The amount is Kenneth's. The edits are Kenneth's. The signature is Kenneth's. The decision to send is Kenneth's â€”</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every client gets a private case-status link that opens on a phone â€” no app to download, no dashboard to learn. Just where the matter stands, in plain English â€”</p>
...
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What should your system take off the desk â€” and what should it never touch?</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Show us one call your firm misses after hours, one document your people still build by hand, and one question clients call to ask again and again. We'll map the first workflow we would build â€” and the hard boundaries we would put around it.</p>
...
<p style="font-family: monospace; font-size: 12px; text-transform: uppercase; letter-spacing: 0.1em; opacity: 0.6; margin: 0 0 1.6em;">${OS_PRICING.monthly}/month + ${OS_PRICING.setup} setup Â· Month-to-month Â· Your firm owns the code and data</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">I'm Trevor. Found It Software, Alexandria, Louisiana.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><em style="opacity:0.6; font-size: 14px;">Every screen shows Kennethâ€™s real system running demo data â€” the names and cases on it are invented. No client information, ever.</em></p>
`,
    },
    {
        ...
        date: '2026-08-25',
        excerpt: 'A truck was loading for Austin and a hand-copied order dropped its last line â€” 44 plants, a thousand dollars in freight, almost gone. So we built her one system that catches every line. She owns all of it.',
        author: 'Trevor Ruby',
        authorImage: '/team-member-1.jpeg',
...
<div style="margin: 2em 0; padding: 1em 1.2em; border: 1px solid #333; border-radius: 16px;"><div style="font-size: clamp(44px, 8vw, 76px); font-weight: 800; line-height: 1; letter-spacing: -0.03em; color: #FF5500;">15 brokers</div><div style="font-size: clamp(15px, 2vw, 18px); opacity: 0.8; margin-top: 0.4em;">fifteen different order formats â€” texts, emails, PDFs, photos of somebody's handwriting</div></div>
...
<p style="margin: 1em 0 1.6em;"><img src="/images/blog/roxanne-blog-pull-sheet-focus-v1.png" alt="The crew's pull sheet: quantities, plants, sizes and trailer slot in big type â€” no customer name, no prices (demo data)" style="border-radius: 12px; border: 1px solid #333;" /></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The crew's screen shows the PO, the plants, the sizes, the trailer slot â€” in type you can read across the yard. It won't show the customer's name and it won't show a price. <span style="color: #FF5500;">&ldquo;That's my business, not the crew's,&rdquo;</span> she said. Custom software is knowing what to build. It's also knowing what to leave off the paper lying in the gravel by the dock.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Plants die â€” in the heat, in a wet week, on the truck. The ones that live carry the cost of the ones that didn't. So it does the math her old software never did: <span style="color: #FF5500;">cost per surviving plant</span>, by plant, by broker. The cheapest sticker price and the cheapest plant are rarely the same broker â€” and now she can prove which is which <span style="color: #FF5500;">before</span> she buys.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Not by a little. Its idea of her bank balance was off by an amount that belongs in science fiction. So we did the slow, boring, honest thing: <span style="color: #FF5500;">rebuilt her books straight from her bank statements â€” every month, tied to the penny.</span> The new system runs <em>beside</em> the one she pays for today, matched to the cent, night after night, until the day it's earned the job. <strong>She flips that switch. Not me. Not a salesman.</strong></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">I'm Trevor. Found It Software, Alexandria, Louisiana.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><em style="opacity:0.6; font-size: 14px;">The screens are real. Every name and dollar on them is invented â€” her book never leaves her building.</em></p>
`,
    },
    {

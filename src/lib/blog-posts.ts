...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Last night I built something for my brother. He runs a serious online store, and he likes to tinker with his website at eleven o'clock at night. That used to be a terrifying sentence. A website is a tower of code, and one wrong move by a well-meaning owner can knock it over, and that costs him real money the next morning.</p>

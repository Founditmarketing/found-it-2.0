...
export const blogPosts: Post[] = [
    {
        ...
        seoDescription:
            'An owned operating system that researches its own next improvement every Monday and builds nothing without the owner’s yes. Cycle one found $498,691.18 at checkout.',
        date: '2026-09-04',
        author: 'Trevor Ruby',
        authorImage: '/trevorruby.jpeg',
        excerpt:
            'Every Monday before dawn, one of the operating systems we built researches its own next improvement and writes one proposal. Then it stops and asks permission. The first cycle ran last night. It found half a million dollars standing at the checkout.',
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The first cycle ran last night. I want to walk through what it picked, and what it refused to pick, because the refusal is half the product.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every piece of rented software has a roadmap. You are not the customer of that roadmap. It serves the vendor: the features that win the next sale, the changes that justify the next price increase, the integrations that make leaving a little harder. Your particular Tuesday problem is a rounding error on it.</p>
...
<div style="margin: 2em 0 0.5em; display: flex; flex-wrap: wrap; gap: 12px;"><a href="/fit" style="display: inline-block; background: #FF5500; color: #0A0A0A; font-weight: 800; padding: 14px 22px; border-radius: 12px; text-decoration: none;">See what your own system would find &rarr;</a></div>
`,
    },
    {

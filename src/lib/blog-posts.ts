...
<div style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 13px; letter-spacing: 2px; text-transform: uppercase; margin: 2.2em 0 0.8em; display: flex; align-items: center; gap: 12px; flex-wrap: wrap;"><span>03&ndash;05 &middot; Next under the law</span> <span style="border: 1px solid #444; color: #999; font-weight: 800; padding: 2px 9px; border-radius: 6px;">In the shop</span></div>
<div style="display: flex; flex-wrap: wrap; gap: 14px; margin: 0.4em 0 0.4em;">
<figure style="flex: 1 1 280px; margin: 0; min-width: 0;"><img src="/images/blog/law-handover-before-v1.png" alt="The owned-software handover page, pre-law" style="width: 100%; height: 300px; object-fit: cover; object-position: top; border-radius: 12px; display: block; filter: saturate(0.35) brightness(0.75); border: 1px solid #333;" /><figcaption style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 2px; text-transform: uppercase; opacity: 0.65; margin-top: 0.7em;">The handover page &middot; 802 words</figcaption></figure>
<figure style="flex: 1 1 280px; margin: 0; min-width: 0;"><img src="/images/blog/law-vsgrok-before-v1.png" alt="The vs-grok comparison page, pre-law" style="width: 100%; height: 300px; object-fit: cover; object-position: top; border-radius: 12px; display: block; filter: saturate(0.35) brightness(0.75); border: 1px solid #333;" /><figcaption style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 2px; text-transform: uppercase; opacity: 0.65; margin-top: 0.7em;">The comparison page &middot; 758 words</figcaption></figure>
<figure style="flex: 1 1 280px; margin: 0; min-width: 0;"><img src="/images/blog/law-posts-before-v1.png" alt="The heaviest blog post, pre-law" style="width: 100%; height: 300px; object-fit: cover; object-position: top; border-radius: 12px; display: block; filter: saturate(0.35) brightness(0.75); border: 1px solid #333;" /><figcaption style="font-family: ui-monospace, SFMono-Regular, monospace; font-size: 12px; letter-spacing: 2px; text-transform: uppercase; opacity: 0.65; margin-top: 0.7em;">The heaviest post &middot; 1,544 words</figcaption></figure>
</div>

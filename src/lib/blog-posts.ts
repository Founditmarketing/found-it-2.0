...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">One question tells you which one you have. <span style="color: #FF5500;">If you stop paying, what is left?</span> Rented: a dead login and your records on somebody else's server. Owned: everything. Still yours. Still running.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Because custom software used to cost fifty to a hundred fifty thousand dollars and take six months. Renting was the only door a shop, a nursery, or a roofing crew could afford. AI collapsed the cost of building, so software built for one business and owned by it now ships at the monthly a business already pays for rented seats. <span style="color: #FF5500;">The name arrives in 2026 because 2026 is the first year it could be true at this price.</span></p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What it is <span style="color: #FF5500;">not.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Not a perpetual license: a frozen copy of somebody else's product. Not self-hosting: their product on your electricity bill. Not a pay-once app: the closest cousin, still one size for everyone. And not "no fees ever." The monthly buys hosting, nightly backups, support you can call, and new features. <span style="color: #FF5500;">Stop paying and the work stops. Not your software.</span></p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">It is already <span style="color: #FF5500;">running.</span></p>

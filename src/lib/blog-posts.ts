...
export const blogPosts: Post[] = [
    {
        ...
        image: '/images/blog/shipwright-og-v1.png',
        hideHero: true,
        content: `
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every Monday before dawn, one of the operating systems we built now wakes up and researches its own next improvement. Not builds. Researches. It reads its own gap lists. It looks at what the software world shipped that week. It checks what new technology just made possible. Then it writes one proposal: what to build, why the owner will feel it, how many days it takes. And it stops. <span style="color: #FF5500; font-weight: 800;">Nothing happens until a human says yes.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">It studies the business, writes one work order, and stops behind a human gate. The first cycle ran last night. I want to walk through what it picked, and what it refused to pick, because the refusal is half the product.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Three feeds, one pick</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The system belongs to a national e-commerce dealer — a real client, name withheld at the owner's request. He sells DIY HVAC gear, and he owns his operating system outright. The code and the data, not a login to somebody else's. The research reads three feeds, in order of weight.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">Its own gap lists.</span> The system keeps written lists of what it cannot do yet, and it watches which of its own screens get looked at but never touched. It reads those first, because nobody knows this business's software better than this business's software.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">What the market shipped.</span> What the e-commerce world put out that week that an owner like this one would want, always with the same question attached: could we build the owned version on rails that already exist?</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><span style="color: #FF5500; font-weight: 800;">What new technology unlocks.</span> Framework releases, new APIs, useful open source. The bar is strict. A finding has to name the concrete feature it unlocks for this one business. Technology for its own sake does not get a seat.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Three independent feeds. Last night, all three converged on the same pick.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Half a million dollars, standing at the checkout</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Say the caveat before a skeptic can: that is not $498,691.18 of missing revenue. Some carts were comparison shopping. Some buyers changed their minds. Some were never coming back. It is 114 carts reaching checkout — and a board recording every one of them without a routine for what happened next.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">In fourteen days, 114 carts reached checkout on this dealer's store and left without buying. Nearly half a million dollars. The system already had a board showing every one of them. The board got looked at. It did not get worked. That gap, between a screen that renders and a person who acts, was the most valuable thing the research found anywhere.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">So the proposal is not a new model or a redesign. It is a morning ritual. A ranked call list for the office: the five biggest walkaways, scored by dollars, freshness, and whether the customer has bought before. Phone numbers first, because this is a call list, not another email. A call script the AI drafts in the company's own voice. And a scoreboard for recovered dollars with one rule I want to frame:</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">If somebody in the office marks a call "said yes," the scoreboard shows it as pending. When the order actually appears in the sales records, it counts. The system does not get to grade its own homework. We hold <a href="/blog/quickbooks-is-cancelled" style="color: #FF5500;">our own books</a> to the same rule.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Estimated work: two and a half days. Attached to the proposal is the complete build order. Every file to touch, every rule that binds the build, and a plain list of what it is not allowed to build. Auto-dialing is on that list. So is sending anything to a customer without a person committing it.</p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">This was not an AI brainstorm</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Anybody can ask a chatbot what feature an online store should build next. That is not the product. The product is the machinery around the answer: what the system is allowed to read, which evidence it must use, how candidates get ranked, why it may bring exactly one recommendation, what it must list as skipped on purpose, which actions are forbidden, where the permanent record goes — and the hard wall between proposing work and performing it.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0; color: #FF5500;">An idea is cheap. A governed path from evidence to action is the product.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Here is the part I care about most. The proposal was finished. The build order was ready. And the machine is not allowed to take the next step. Not discouraged. <span style="color: #FF5500; font-weight: 800;">Not allowed.</span> Nothing builds from research, ever, without the owner's yes. The answer takes one word: go, or skip. A skip gets logged with the reason, because the reasons teach next week's cycle what this business considers worth building. Self-improving does not mean self-authorizing.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Yesterday I wrote about <a href="/blog/giving-owners-full-control" style="color: #FF5500;">Owner Mode</a>: the AI reads, drafts, and prepares, and the owner keeps authority over everything that matters. This is Owner Mode pointed at the roadmap itself. <span style="color: #FF5500; font-weight: 800;">The machine proposes. The owner disposes.</span></p>
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What it skipped matters as much as what it picked</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The proposal ships with a section titled "skipped on purpose." Two entries from last night, in the machine's own words. On sending push notifications to the crew's phones:</p>
<div style="margin: 1.4em 0; padding: 0.9em 1.2em; border-left: 3px solid #FF5500; opacity: 0.75; font-style: italic;"><p style="margin:0;">"Buzzing phones before the queue ranks dollars is noise-first plumbing; the owner feels recovered revenue, not a badge count. Right build, wrong week."</p></div>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And on the big internal AI framework upgrade it could have chosen instead:</p>
<div style="margin: 1.4em 0; padding: 0.9em 1.2em; border-left: 3px solid #FF5500; opacity: 0.75; font-style: italic;"><p style="margin:0;">"The most technically interesting item on the board, which is exactly the warning: five to seven days of chassis and on day seven the owner feels nothing."</p></div>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Read that second one again. It talked itself out of the project an engineer would pick, and it wrote down why: the owner would not feel it. I have sat in meetings where the humans could not manage that.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every rented product has one roadmap shared by thousands of customers. A good vendor may listen closely. It still has to build for the market, not for one company's strange Tuesday problem. You are a customer of the product — and <span style="color: #FF5500; font-weight: 800;">one vote on the roadmap</span>. To mass-market software, your exact operational gap is a rounding error. To software owned by one business, that business is the entire market.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">I keep saying nobody rents you your own business back. Here is what the other road looks like when you follow it all the way down. This dealer owns his system, so the roadmap belongs to him too. And now it researches itself. Every Monday proposal is committed into his own repository, next to his own code. <span style="color: #FF5500; font-weight: 800;">The research trail is part of what he owns.</span> If we disappeared tomorrow, he keeps the software, the data, and every week of written thinking about where it should go next.</p>
...
<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Why we call it the Shipwright</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">A shipwright does not sail the ship, and he does not own her. He walks the hull, finds the plank that needs replacing next, and brings the captain the work order. The ship gets better every week. <span style="color: #FF5500; font-weight: 800;">Not one plank moves without the owner's hand on the order.</span> She never stops being the captain's ship.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">As I write this, one cycle has run, once. The pick is not built yet. The call list does not exist, the scoreboard shows nothing, and none of those 114 carts has been called. That is the correct state for a system that asks first. When the scoreboard has something real to say, I will publish what it says. If the recovered number turns out to be small, I will publish that too.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">If your software researched your business every Monday and brought you one proposal, what would week one find? Somewhere in your operation there is probably a board that shows real money and never gets worked. Your software should be the one that finds it.</p>

...
export const blogPosts: Post[] = [
    {
        ...
        date: '2026-08-28',
        excerpt: 'In 1999 somebody named the idea of renting software over the internet, and the name built a trillion-dollar category. The opposite idea has existed the whole time. Perpetual licenses, on-premise, self-hosted, pay-once apps. Every one of those describes how you buy it or where it runs. None of them ever named what you actually have. So here is the name: owned software. SaaS is rented software. Owned software is the opposite. One question tells you which one you have: if you stop paying, what is left?',
        author: 'Trevor Ruby',
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">In 1999 somebody needed a name for a new idea: instead of selling you software, they would run it on their computers and charge you every month to reach it. They called it <span style="color: #FF5500;">Software as a Service.</span> SaaS. The name did more work than the code did. Give an idea a name and people can buy it, sell it, invest in it, build careers on it. That name built a trillion-dollar category. Almost every program your business runs on today is SaaS, and you pay for all of it forever.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">But look at what the name smuggled past everybody. A service is something you use and never own. The name renamed renting so smoothly that nobody noticed the deal underneath it. You pay every month, forever, for software that is never yours, holding records that are barely yours, on terms that can change whenever the landlord feels like it.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">The opposite idea existed the whole time. <span style="color: #FF5500;">Nobody ever named it.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And I want to be straight about the history, because the idea of owning your software is not new and I am not going to pretend it is. Perpetual licenses were how everybody bought software before subscriptions ate the world. On-premise means it runs on your server. Self-hosted means the same thing with a beard. 37signals sells pay-once apps and says the subscription era went too far, and they are right. Smart people have been circling this for years.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Now read that list again. <span style="color: #FF5500;">Every one of those names describes how you paid or where it runs.</span> A perpetual license. An on-premise deployment. A self-hosted install. Purchase mechanics and server locations. Not one of them names the thing a business owner actually cares about: what do you HAVE when the dust settles? SaaS got a name that sells itself. The opposite got a pile of IT terminology. That is why the category never formed, and that is the whole gap.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">So here is the name. <span style="color: #FF5500;">Owned software.</span></p>
<div style="margin: 2em 0; padding: 1.2em 1.4em; border: 1px solid #FF5500; border-radius: 16px;">
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.45; margin: 0 0 0.8em;"><strong>Owned software</strong> is business software the business owns outright: the code and the data. It is built for one business and fitted to how that business actually runs. Its old records are migrated in, not abandoned. It runs beside the system it replaces until the numbers match and the owner says go. And if the software company disappears tomorrow, the software is still there, still running, still the owner's property.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">One question tells you which one you have. <span style="color: #FF5500;">If you stop paying, what is left?</span> Rented software: a login that stops working and your own records held on somebody else's server while you beg for an export. Owned software: everything. Still yours. Still running.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">Why the category shows up now and <span style="color: #FF5500;">not twenty years ago.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Because until about two years ago, owned software for a normal business was a fantasy. Custom software meant fifty to a hundred fifty thousand dollars, a six-month build, and a maintenance contract that never ended. SaaS won because it was the only thing a shop, a nursery, or a roofing crew could afford. Renting was not a preference. It was the only door.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">AI collapsed the cost of building. What took a team six months takes a builder who knows what he is doing a few weeks. Which means the real thing, software built for one business and owned by it, now ships at the same monthly a business already pays for rented seats. <span style="color: #FF5500;">The economics flipped, and the category the old names could never carry finally gets to exist.</span> The name arrives in 2026 because 2026 is the first year it could be true at this price.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">What owned software is <span style="color: #FF5500;">not.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Not a perpetual license. That is a frozen copy of somebody else's product, aging in place. Not self-hosting. That is their product on your electricity bill. Not a pay-once app. That is the closest cousin and I respect it, but it is still a copy of a mass-produced product, one size for everyone. Owned software is built around one business the way a bespoke suit is cut around one body. Your workflows, your words, your history in it from day one.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And it is not "no fees ever." There is a monthly, and it buys work: hosting, nightly backups, support you can call, new features as the business grows. <span style="color: #FF5500;">Stop paying and the work stops. Not your software.</span> That is the whole difference, and it is the difference the word service was invented to blur.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">This is not a theory. <span style="color: #FF5500;">It is running.</span></p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">A roofer's owned system audited his own books the day it went live and surfaced <span style="color: #FF5500;">$195,882.75</span> in open receivables his rented apps had scattered across three logins. A wholesale nursery's system enforces one rule her old stack never could: lines in equals lines on the pull sheet, and anything odd gets held in red instead of falling off a hand-copied order. A transmission shop's entire history, 432 customers and 876 orders and $828,000 of records, moved into its owned system in an afternoon. Real Louisiana businesses, running on software they own, right now.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">And the price is printed, because owned software should not play the custom-software pricing game either: ${OS_PRICING.monthly} a month plus ${OS_PRICING.setup} one-time migration and setup. Month to month. Cancel with 30 days notice and the system leaves with you. The code and the data.</p>

<p style="font-size: clamp(28px, 5vw, 44px); font-weight: 800; line-height: 1.08; letter-spacing: -0.02em; margin: 1.6em 0 0.35em;">The category test, one more time.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Open the software your business runs on. Ask it the question. <span style="color: #FF5500;">If I stop paying, what is left?</span> If the honest answer is nothing, you know what you have, and now you know its name too. It is rented. And for the first time, renting has an opposite you can actually buy.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;"><a href="/fit" style="color: #FF5500; font-weight: 700;">Sixty seconds tells you if you're who we build for.</a> Or see <a href="/foundit-os" style="color: #FF5500; font-weight: 700;">what a Found It OS is</a> with your own eyes.</p>
`,
    },
    {
        ...
        content: `
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Alexandria, Louisiana.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Every Found It OS ships with its own set of books built in. A journal, a ledger, the reports your accountant asks for every year. It replaces QuickBooks. This is the story of why I built it, and it starts with the worst set of books I have ever opened.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Strip away the customer side, the invoices and estimates your shop system already handles better, and the bookkeeping engine underneath comes down to ten parts: a journal, a general ledger, a chart of accounts, a profit and loss, a balance sheet, cash flow, sales tax, bank reconciliation, accounts payable, printable checks. And underneath all ten sits math that is <span style="color: #FF5500;">seven hundred years old and still undefeated</span>. Double-entry bookkeeping. Every entry has two sides and the two sides have to agree, which means the books check themselves. Merchants worked that out before Columbus sailed and nobody has improved on it since, because you can't.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">QuickBooks kept the seven-hundred-year-old math. Then it broke the one rule that made the math worth anything: <span style="color: #FF5500;">it lets anybody go back and edit history.</span> There is an audit log, sure. The audit log records the rewrite. It does not refuse it. A self-checking system where the past can be rewritten is not self-checking. It just feels like it.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">I rebuilt all ten pieces and put them inside every Found It OS. Your shop system and your books, one login, talking to each other all day. It does not feed QuickBooks and it does not sit on top of it. <span style="color: #FF5500;">It takes its place.</span></p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Once an entry is written, it is written. Not me, not you, not an employee having a bad day. The system physically will not do it. Make a mistake and you fix it in the open, with a reversal entry that carries its own date. The mistake shows and the fix shows.</p>
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">Before anybody tells me that's extreme, look at where you already trust it. Your <span style="color: #FF5500;">bank</span> keeps its books this way. The bank never edits a transaction, it posts a correction, and that is why you believe your statement. Courthouses keep records this way. Every set of books the world actually trusts works this way. About the only place editable history survives is the accounting software small businesses rent, and that is not a coincidence. <span style="color: #FF5500;">That is the defect.</span> Ask an auditor what she wants from a set of books and she will describe ours: books that show their work.</p>
...
<p style="font-size: clamp(17px, 2.4vw, 21px); line-height: 1.35; opacity: 0.85; margin: 0 0 0.8em;">The new books run beside your QuickBooks, matched to the penny, day after day, until you have watched the two agree long enough to trust it. Then <span style="color: #FF5500;">you</span> say go, on your clock, not a salesman's.</p>

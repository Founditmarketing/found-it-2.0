...
<p style="margin: 0 0 1em;">Cheap technology just made it possible. The watch is why they&rsquo;ll want it.</p>
<p style="margin: 0 0 1em;">I didn&rsquo;t get this from a book. I watched it all year in a century-old menswear shop I do work for &mdash; and I love that store. I love the way it treats a man. A man can buy clothes anywhere &mdash; clothes are cheap now too. He goes there because somebody is <em>responsible for his wardrobe</em>. The fitting, the service, the person who knows him. Better experience. Better end result.</p>
<p style="font-size: clamp(24px, 4vw, 36px); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em; margin: 1.2em 0 1.6em;">The software is not the product. Everything that surrounds it is.</p>

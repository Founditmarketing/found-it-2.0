    ...
    <section className="relative py-20 lg:py-32">
      <div className="max-w-[1440px] mx-auto px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: ease as any }} className="text-center mb-16">
          <p className="text-primary font-mono text-xs font-black uppercase tracking-[0.4em] mb-4 opacity-80">The Shift</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10 mb-16">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <p className="mt-2 text-[9px] font-mono uppercase tracking-[0.3em] text-faint">Source: {stat.source}</p>
            </motion.div>
          ))}
        </div>

...
export function ClientBackground() {
    return (
        <div className="fixed inset-0 z-[0] bg-[#020202] pointer-events-none overflow-hidden">
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[50vw] h-[50vw] bg-primary/10 rounded-full blur-[150px] animate-blob" />
            <div className="absolute top-[20%] right-[-10%] w-[40vw] h-[40vw] bg-amber-500/10 rounded-full blur-[150px] animate-blob animation-delay-2000" />
            <div className="absolute bottom-[-20%] left-[20%] w-[60vw] h-[60vw] bg-orange-600/10 rounded-full blur-[150px] animate-blob animation-delay-4000" />

        ...
        steps={[
          {
            ...
            description:
              'About an hour at your place. We walk the counter, the yard, the service bay, and the books with you — and map the app we’d build if we owned your dealership. You add to it or take away. And we’re deciding the same thing you are: whether this is a fit. If it isn’t — either direction — we tell you straight, tell you what we’d do instead, and you keep the map.',
          },
          {
            number: '02',

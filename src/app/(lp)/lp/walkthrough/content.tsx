  ...
  return (
    <AdLpTemplate
      ...
      hero={{
        ...
        subheadline:
          "Could your current software answer that in five seconds? Ours can. And that's only one question your business could answer. We put your whole operation — customers, jobs, estimates, invoices, the books — into one custom system built around the way you actually work. And you own it. Sign up below and we'll show you what yours would look like, free. Hire us or don't.",
      }}
    />
  );
}

  ...
  return (
    <AdLpTemplate
      ...
      hero={{
        ...
        subheadline:
          "The estimate app. The job board. The books. Somebody at your shop re-types the same job into all three — and 10 hours a week at $20/hr is $10,400 a year spent moving information between apps you rent. One custom system enters it once: customers → estimates → jobs → invoices → the books. Built around how you run, and you own it. Sign up below and we'll map yours free — you keep the map either way.",
        highlight:

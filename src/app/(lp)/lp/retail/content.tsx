  ...
  return (
    <AdLpTemplate
      ...
      hero={{
        ...
        subheadline:
          "Sales, sizes, low stock, what needs reordering — your store should answer all of it before the doors open, without you exporting a thing. We build custom systems for stores, fitted to how yours actually runs: the register, the shelves, the reorders, the books. And you own it — the code and the data. Sign up below and we'll map yours free. You keep the map, hire us or don't.",
        highlight:

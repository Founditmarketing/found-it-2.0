...
const data: PillarData = {
  ...
  intro:
    `Every builder on CoConstruct has to move somewhere. Another rented seat, or a system you own. Draws, selections, change orders, sub scheduling. The takeoff line IS the estimate line. Records migrate in, and nothing switches until the new system runs beside your old one and matches it.`,
  ...
  definition:
    'A builder OS is one system that runs a home building operation. Not a rented platform with spreadsheets taped around it. The spine: the takeoff line IS the estimate line. Nothing gets retyped, so nothing drifts. Ask it plain-English questions. Which selections are overdue, which draw comes next. It answers from your own jobs. And you own it. The code, the data, everything.',
  includedHeading: 'What the Builder OS Is Built Around',
  included: [
    {
      title: 'The Takeoff Line Is the Estimate Line',
      detail:
        'One line, measured once, carries through takeoff, estimate, draw schedule, and change order. No retyping, no drift.',
    },
    {
      title: 'Draws & Draw Schedules',
      detail:
        'Built from the same lines as the estimate. What you bill the bank matches what you priced.',
    },
    {
      title: 'Selections',
      detail:
        'Allowances, deadlines, and client decisions in one place. A late selection never stalls a job silently.',
    },
    {
      title: 'Change Orders',
      detail:
  ...
  approach: [
    {
      ...
      title: 'The Fitting',
      detail:
        'We map how a job really runs, first takeoff to final draw, spreadsheets and email included. That becomes the blueprint.',
    },
    {
      step: '02',
      title: 'Built Beside Your Old System',
      detail:
        'CoConstruct, or whatever you run today, keeps running. The new system runs beside it, and the two are checked against each other.',
    },
    {
      step: '03',
      title: 'You Say Go',
    ...
    },
    {
      ...
      title: 'We Stay On',
      detail:
        'Nightly backups, support you can call, new features as you grow. Local, in person when you need us.',
    },
  ],
  ...
  result: {
    ...
    narrative:
      'The builder OS is in fitting with a custom home builder right now. Design partners come in the same door. When CoConstruct goes dark, you are already running a system that is yours.',
  },
  ...
  mistakes: [
    {
      ...
      detail:
        'Every builder on CoConstruct has to move by roughly mid-2027. Wait, and you migrate in a crowd, mid-build, in a hurry.',
    },
    {
      title: 'Retyping the takeoff',
      detail:
        'When the takeoff lives in one tool and the estimate in another, every retype lets the numbers drift. Drift comes out of your margin.',
    },
    {
  ...
  faq: [
    {
      ...
      answer:
        'Yes. Most CoConstruct alternatives are another rented seat. This is the other path: a builder OS fitted to how you run jobs, owned outright. It is in fitting with a custom home builder now, and we are recruiting design partners before the sunset.',
    },
    {
      question: 'What happens when CoConstruct shuts down?',
      answer:
        "Builders need to be off it by roughly mid-2027. Start a fitting now, and your records migrate in while CoConstruct still runs. The switch happens on your schedule, not the sunset's.",
    },
    {
      question: 'What does "design partner" mean?',
      answer:
        'You get fitted first. We map how your jobs run, build around that, and what you hit in the field drives what gets built next. You own it, code and data, when it is done.',
    },
    {
      question: 'Does it handle draws, selections, and change orders?',
      answer:
        'That is the core of it. Draws, selections, change orders, and sub scheduling all hang off one spine: the takeoff line IS the estimate line. Measure once, and the same number flows everywhere.',
    },
    {
      question: 'How is this different from Buildertrend?',
      answer:
        "Buildertrend is a capable platform. Rented software is built for every builder, so it fits none exactly, and your data lives behind someone else's login. A fitted builder OS is built around your operation, and you own it outright.",
    },
    {
  ...
  finalCtaSub:
    `Tell us how your jobs run today. The takeoffs, the draw schedules, the selection emails, the change orders on sticky notes. We will show you what your own builder OS would look like.`,
};

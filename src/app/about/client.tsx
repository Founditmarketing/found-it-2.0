    ...
    <main className="bg-transparent text-foreground pt-32 lg:pt-40 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-[900px] mx-auto px-6 relative z-10">
        ...
        {/* ─── Make Us Disappear: OFF the page (Trevor 9/5, "kill the make us
            ...
            component now lives at src/components/DisappearDemo.tsx, mounted
            on /owned-software — import it back here if he calls for it. ─── */}
        ...
        {/* The house close — THE ASK (born here 9/5, now sitewide) */}
        <TheAsk />
